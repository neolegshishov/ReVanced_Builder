...
$LatestSupportedYT = ((Invoke-RestMethod @Parameters).patches | Where-Object -FilterScript {$_.name -eq "Video ads"}).compatiblePackages"com.google.android.youtube" | Sort-Object -Descending -Unique | Select-Object -First 1
